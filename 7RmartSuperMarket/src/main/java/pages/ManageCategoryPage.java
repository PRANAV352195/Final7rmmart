...
import utitlities.FileUploadUtility;
...
//	WebElement del_btn;
	...
	public ManageCategoryPage clickDelete(String category_name) {	
		...
		WebElement deletebutton=driver.findElement(By.xpath("//tr[td[contains(text(),'"+category_name+"')]]//a[contains(@href,'category/delete')]"));
		deletebutton.click();
