...
public class ManageContactTest extends Base {
	...
	public void verifyTheUpdateButtonIsDisplayed() throws IOException{
		...
		Assert.assertTrue(isUpdateButtonDisplayed,Constants.MANAGECONTACTUPDATEBUTTONISNOTDISPLAYED);
	...
	public void verifyUserIsAbleToEditContact() throws IOException{
		...
		manage_contact_page=home_page.clcickManageContactMoreInfo();
		manage_contact_page.clickActionButton();
		manage_contact_page.clearAll().enterPhoneNumber(ExcelUtility.getIntegerData(1, 0, "managecontact"))
		...
		Assert.assertTrue(isAlertDisplayed,Constants.MANAGECONTACTPAGEINEDITCONTACTNODISPLAYED);
	}
